...
module.exports.MessageDeleted = (client, message, sqlcon) => {
    ...
    GetLoggingStatus(sqlcon, message.guild.id, LogObject);
    setTimeout(function () {
...
module.exports.MessageEdited = (client, oldMSG, newMSG, sqlcon) => {
    let LogObject = new Object()
    GetLoggingStatus(sqlcon, oldMSG.guild.id, LogObject);
...
module.exports.MemberAdd = (client, member, sqlcon) => {
    let LogObject = new Object()
    GetLoggingStatus(sqlcon, member.guild.id, LogObject)
...
module.exports.MemberUpdate = (client, oldMem, newMem, sqlcon) => {
    let LogObject = new Object()
    GetLoggingStatus(sqlcon, oldMem.guild.id, LogObject)
...
function GetLoggingStatus(sqlcon, ID, LogObject) {
